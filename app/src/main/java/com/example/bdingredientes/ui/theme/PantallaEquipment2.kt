...
@Composable
fun PantallaEquipment2(db : VMBD4, sf: ViewModelScaffold, navController: NavController, launcher: ActivityResultLauncher<Intent>) {
    ...
    Column {
        ...
        Row {
            ...
            if (delete.value) {
                ...
                } else "Aquí están todos tus utensilios"
                    ...
                    when (nombre2) {
                        ...
                        "Well-Done Alarm" -> {
                            ...
                            if (!idioma.value) {
                                ...
                                celebracionT = when (celebracion2) {
                                    "Standard" -> {
                                        "Estándar"
                                    }
                                    "Baseball Season" -> {
